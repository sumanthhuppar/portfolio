...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <h3 className='home__subtitle'>Web Enthusiast</h3>
        <p className="home__description">I'am a Student at VidyaVardaka college of engineering, Persuing my degree as an Information Science Engineer. I'm very much passionate about FullStack Development.</p>
